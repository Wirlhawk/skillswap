...
export default async function ProfilePage({ params }: PageProps) {
    ...
    const isSeller = isOwnProfile; // For now, assume own profile means seller

    // Fetch seller data if it's the user's own profile
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div className="space-y-6">
                        ...
                        {/* Seller Stats Card - Only show if it's the user's own profile and they have stats */}
