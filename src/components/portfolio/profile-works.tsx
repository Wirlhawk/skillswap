...
import { Eye, Heart, MessageCircle, Share2, Edit, Trash2, Plus } from "lucide-react"
...
export default function ProfileWorks() {
  const [works, setWorks] = useState<Work[]>([
    {
      ...
      description: "Desain website e-commerce modern dengan fokus pada user experience dan konversi yang tinggi.",
      category: "web-design",
    ...
    },
    {
      ...
      description: "Identitas visual lengkap untuk coffee shop lokal, termasuk logo, packaging, dan merchandise.",
      category: "branding",
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Koleksi karya terbaik yang telah saya buat untuk berbagai klien dan proyek personal
          </p>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            {categories.map((category) => (
              <Button
                ...
                className={filter === category.value ? "bg-gradient-to-r from-emerald-600 to-teal-600" : ""}
              >
                {category.label}
              </Button>
            ))}
          ...
          {filteredWorks.map((work) => (
            <Card key={work.id} className="group hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-emerald-600 transition-colors">{work.title}</h3>
        ...
        {filteredWorks.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Mulai tambahkan karya pertama Anda</p>
            <Button
              onClick={() => setShowUploadForm(true)}
              className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700"
            >
      ...
      {/* Upload Form Modal */}
      {showUploadForm && <UploadForm onSubmit={handleAddWork} onClose={() => setShowUploadForm(false)} />}

      {/* Media Preview Modal */}
      {selectedWork && <MediaPreview work={selectedWork} onClose={() => setSelectedWork(null)} />}
    </section>
  )
}
