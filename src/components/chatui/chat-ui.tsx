        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-8">
          <div className="max-w-2xl text-center space-y-6">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-card-foreground">AI Chat Widget Demo</h1>
              <p className="text-xl text-muted-foreground">Experience our embeddable chat widget with a soft green theme</p>
            </div>

            <div className="bg-secondary-foreground rounded-2xl p-8 shadow-lg border space-y-4">
              <h2 className="text-2xl font-semibold text-card-foreground">Features</h2>
              <div className="grid md:grid-cols-2 gap-4 text-left">
                <div className="space-y-2">
                  <h3 className="font-medium text-primary">✨ Modern Design</h3>
                  <p className="text-sm text-muted-foreground">Clean, rounded corners with subtle shadows</p>
                </div>
                <div className="space-y-2">
                  <h3 className="font-medium text-primary">💬 Smart Responses</h3>
                  <p className="text-sm text-muted-foreground">Contextual AI responses to common queries</p>
                </div>
                <div className="space-y-2">
                  <h3 className="font-medium text-primary">📎 File Upload</h3>
                  <p className="text-sm text-muted-foreground">Attach files and documents easily</p>
                </div>
                <div className="space-y-2">
                  <h3 className="font-medium text-primary">🎨 Customizable</h3>
                  <p className="text-sm text-muted-foreground">Configurable colors, title, and avatar</p>
                </div>
              </div>
            </div>
