...
import { X, Heart, MessageCircle, Share2, Download, ChevronLeft, ChevronRight, Eye } from "lucide-react"
...
export default function MediaPreview({ work, onClose }: MediaPreviewProps) {
  const [currentImageIndex, setCurrentImageIndex] = useState(0)
  const [isLiked, setIsLiked] = useState(false)

  // Mock images for preview since we don't have actual uploaded files
  const mockImages = [
    `/placeholder.svg?height=600&width=800&query=${work.title} main`,
    `/placeholder.svg?height=600&width=800&query=${work.title} detail 1`,
    `/placeholder.svg?height=600&width=800&query=${work.title} detail 2`,
  ]
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="w-full max-w-6xl max-h-[90vh] bg-white rounded-xl overflow-hidden flex flex-col lg:flex-row">
        {/* Image Section */}
        ...
        <div className="w-full lg:w-96 p-6 flex flex-col">
          <div className="flex-1">
            ...
            <h2 className="text-2xl font-bold mb-3 text-gray-900">{work.title}</h2>

            <p className="text-gray-600 mb-6 leading-relaxed">{work.description}</p>
            ...
            <div className="mb-6">
              <h3 className="font-semibold mb-2 text-gray-900">Dibuat:</h3>
