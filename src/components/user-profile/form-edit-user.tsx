      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 p-8 text-center">
        ...
        <div className="relative space-y-4">
          ...
          <p className="text-slate-600 text-xl max-w-2xl mx-auto leading-relaxed">
            Showcase your talents and connect with amazing opportunities in our
            community of 200+ students
          </p>
        </div>
      </div>
            ...
            <CardContent className="space-y-6">
              <div className="flex flex-col items-center space-y-6">
                <div className="relative group">
                  <Avatar className="h-36 w-36 border-4 border-white shadow-xl shadow-slate-200/50 transition-transform group-hover:scale-105">
                    <AvatarImage
            ...
            <CardContent className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <Textarea
                  ...
                  className="border-slate-200 focus:border-emerald-400 focus:ring-emerald-400/20 min-h-[140px] rounded-xl resize-none"
                />
              </div>
